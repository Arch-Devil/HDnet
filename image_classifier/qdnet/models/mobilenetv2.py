...
class Mobilenet(nn.Module):
 ...
 def __init__(self, enet_type, out_dim, drop_nums=1, pretrained=False, metric_strategy=False):
  ...
  if enet_type in ["mobilenet"]:
    self.enet = mobilenetv2()
  if(pretrained):
    param_dict = torch.load('./qdnet/models/pretrained/mobilenetv2-c5e733a8.pth')
    self.enet.load_state_dict(param_dict)
